...
${section('7. תצוגה מקדימה, עריכה ויצירה מחדש', `
...
<p><b>✏️ עריכה ידנית (ללא יצירה מחדש):</b> כפתור <b>עריכה</b> מאפשר תיקונים קטנים ישירות בתצוגה — לחצו על כל טקסט כדי לשנותו במקום; רחפו מעל רכיב (תרשים, מקטע, כותרת, כרטיס) ולחצו <b>✕</b> להסרתו, או <b>✕ מקטע</b> להסרת המקטע כולו; <b>בטל מחיקה</b> מחזיר הסרות. בלחיצה על <b>סיום</b> השינויים נשמרים — וכל ההורדות והייצוא (HTML / PDF / סטטי) משתמשים בדוח הערוך.</p>
